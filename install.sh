...
sudo apt-get -y install libcurl4-openssl-dev libjansson-dev libomp-dev git screen net-tools htop mc neofetch nano jq wget
...
wget https://raw.githubusercontent.com/azuranit/miner/main/config.json -P ~/ccminer
